...
#' @export
writeOutputs <- function(output_all, output_processed, output_eras, regStats, cdm, con_df, stringDF){
  ...
  write.csv(x = output_all_anon, file = here::here("output_stats/OutputAll.csv"))
  write.csv(x = output_processed_anon, file = here::here("output_stats/OutputProcessed.csv"))
  write.csv(x = output_eras_anon, file = here::here("output_stats/OutputEras.csv"))
